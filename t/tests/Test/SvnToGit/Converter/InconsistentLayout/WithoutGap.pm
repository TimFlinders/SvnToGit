...
package Test::SvnToGit::Converter::InconsistentLayout::WithoutGap;
...
my $fixture_dir = "$fixtures_dir/inconsistent_layout_without_gap";
...
# test converting a repo with an inconsistent layout (no gap)
# - all commits present
...
sub test_authors_file_option : Tests {
  ...
  my @expected_authors = qw(john joe joe jane jane jane john john john);
